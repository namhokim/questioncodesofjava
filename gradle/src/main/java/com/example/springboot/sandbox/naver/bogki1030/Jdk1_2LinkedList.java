package com.example.springboot.sandbox.naver.bogki1030;
...
public class Jdk1_2LinkedList extends AbstractSequentialList
        implements List, Cloneable, java.io.Serializable
{
     ...
     * iterator.
     */
    public Jdk1_2LinkedList(Collection c) {
        this();
        addAll(c);
    }
    ...
    public ListIterator listIterator(int index) {
        return new com.example.springboot.sandbox.naver.bogki1030.Jdk1_2LinkedList.ListItr(index);
    }
    ...
    private class ListItr implements ListIterator {
        ...
        public void remove() {
            com.example.springboot.sandbox.naver.bogki1030.Jdk1_2LinkedList.this.remove(lastReturned);
     ...
     */
    public Object clone() {
        return new com.example.springboot.sandbox.naver.bogki1030.Jdk1_2LinkedList(this);
    }
